...
Irányítás:
  ...
  Kocka:
    ...
    -Vízszintes sor kiválasztás = Numerikus gombok (1, 2, 3) / egérkattintás a választó gombokra
    -Fügőleges oszlop / sor kiválasztás = Numerikus gombok (4, 5, 6) / egérkattintás a választó gombokra
    ...
    -Visszaállítás az alapra (kirakott kocka) = T / egérkattintás a Default gombra
	-Random összekeverés = G / egérkattintás a Random gombra
  Fény:
  ...
  Egyév:
	...
	-Help menü egjelenítés/elrejtés = H
		-Helpmenüben navigálni a fenti címek közötti kattintással lehet
```
